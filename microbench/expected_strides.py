...
if __name__ == "__main__":
    ...
    plot_hist_strides(stride_sizes_unsorted, "stride_sizes_zipfian_unsorted_offline")
    plot_hist_strides(stride_sizes_sorted, "stride_sizes_zipfian_sorted_offline")
    ...
    plot_hist_strides(univ2_stride_sizes_unsorted, "stride_sizes_imc_univ2_unsorted_offline")
    plot_hist_strides(univ2_stride_sizes_sorted, "stride_sizes_imc_univ2_sorted_offline")

    equinix_nyc_stride_sizes_unsorted = {
        f"equinix nyc batch size {batch_size} (unsorted)": EQUINIX_NYC_DATA["stride_sizes_per_batch"][batch_size]["unsorted"] for batch_size in EQUINIX_NYC_DATA["stride_sizes_per_batch"]
    }
    equinix_nyc_stride_sizes_sorted = {
        f"equinix nyc batch size {batch_size} (sorted)": EQUINIX_NYC_DATA["stride_sizes_per_batch"][batch_size]["sorted"] for batch_size in EQUINIX_NYC_DATA["stride_sizes_per_batch"]
    }

    plot_hist_strides(equinix_nyc_stride_sizes_unsorted, "stride_sizes_equinix_nyc_unsorted_offline")
    plot_hist_strides(equinix_nyc_stride_sizes_sorted, "stride_sizes_equinix_nyc_sorted_offline")
